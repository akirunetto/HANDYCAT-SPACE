...
pygame.display.set_caption("TERMINAL SHOOTER: BULLET HELL EDITION")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        # Menggunakan PLAYER_FONT agar visual player lebih kecil
...
def draw_main_menu(surface):
    ...
    draw_text_centered(surface, "BULLET HELL EDITION", UI_FONT, NEON_CYAN, 200)
...
def draw_tutorial(surface):
    ...
    info = [
        ...
        "[B] - USE BOMB (CLEAR SCREEN)",
        "", "ADAPTIVE DIFFICULTY:",
        "UPGRADE FIRE RATE -> MORE ENEMIES",
        "UPGRADE DAMAGE -> TOUGHER ENEMIES",
        "", "ITEMS:",
        "[BOMB] - Add Bomb", "[SHIELD] - Invincible", "[+] - Heal HP",
